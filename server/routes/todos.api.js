...
const checkGuestRateLimiter = require('../middlewares/checkGuestRateLimiter');
...
router.get(
  '/reset-today',
  authMiddleware,
  checkGuestRateLimiter, // 게스트 호출 제한
  todoController.resetTodayTodos,
);
...
router.get(
  ...
  authMiddleware,
  checkGuestRateLimiter, // 게스트 호출 제한
  todoController.searchTodayTodos,
);
